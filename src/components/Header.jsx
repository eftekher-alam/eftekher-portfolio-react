      ...
      <div id='home' style={{ backgroundImage: `url(${bg})` }} className=' bg-center bg-cover bg-no-repeat h-screen flex flex-col '>
        ...
        <div className="wrapper flex justify-between items-center h-screen w-full px-20 lg:justify-center lg:px-6">
          <div className="content lg:text-center">
            ...
            <h1 className='text-white text-5xl font-bold'>Hi! I'm Eftekher</h1>
            <p className='text-white py-4 max-w-lg '>I'm a passionate MERN Stack Developer with a deep love for crafting web experiences that make a difference. My journey in web development is driven by a curiosity for technology and a dedication to creating user-friendly, robust web applications.</p>
